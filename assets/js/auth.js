...
function updateUserUI(){
  ...
  if(user){
    ...
    slot.innerHTML = `
      <a class="back" href="../auth/login.html">Login</a>
...
function register(){
  ...
  if(!name || !email || !pass){
    ...
    $("authMsg").innerHTML = "⚠ Please fill all fields.";
  ...
  if(!otpVerified){
    ...
    $("authMsg").innerHTML = "⚠ Please verify OTP first.";
  ...
  if(users.some(u => u.email === email)){
    ...
    $("authMsg").innerHTML = "❗ Email already registered.";
...
function login(){
  ...
  if(!user){
    ...
    $("authMsg").innerHTML = "❗ Invalid email or password.";
